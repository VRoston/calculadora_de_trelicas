...
def botão_confirmar():      
    ...
    botão_confirmar = ctk.CTkButton(containerframe, text="proximo", command=lambda: teste()) # usa a função Button para criar um botão 
...
def teste():
    ...
    plotcanvs.create_line(3,2,4,5, width=300, tags='elements')
